...
<aside id="separator-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 border-e border-gray-200 dark:border-gray-700">
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <button type="button" class="flex items-center w-full justify-between px-2 py-1.5 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" aria-controls="dropdown-users" data-collapse-toggle="dropdown-users">
            ...
            <ul id="dropdown-users" class="hidden py-2 space-y-2">
               <li>
                  <a href="{{ url('/admin/users') }}" class="pl-10 flex items-center px-2 py-1.5 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">All Users</a>
               </li>
               <li>
                  <a href="{{ url('/admin/users/create') }}" class="pl-10 flex items-center px-2 py-1.5 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">Add New User</a>
               </li>
            </ul>
         </li>
