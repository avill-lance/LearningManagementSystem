...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 20, 2026 at 08:39 AM
...
/* Login data now belongs in users.
...
(2, NULL, 24, 'student', 'vidogikel', '$2y$12$fgMgWYlonk.30PH1yXeQhegKMVVy1dNOSzp5wdePaYoi93BUq1IW.', 'kcpogi09@gmail.com', 'Active', 1, 0, '2026-08-27 22:23:36', 0, NULL, '2026-09-11 20:14:30', '127.0.0.1', NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2026-08-28 04:23:36', '2026-09-11 20:14:30'),
(4, NULL, 5, 'teacher', 'biwulyhyxe', '$2y$10$zjCcBtl2noHjQk2Z4mnVtOE/epaN78VpLjAsYnDtbaI2ZmzcVyeOO', 'kajymojizu@mailinator.com', 'Active', 1, 0, '2026-09-04 23:45:32', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2026-09-05 05:45:32', '2026-09-05 05:45:32'),
(5, NULL, 27, 'student', 'zuqugidysy', '$2y$10$i1oxfuU3QtGvNRWFRLs8X.p9K05CT.vqIM1esmfHk2VrZ47KEOT3a', 'momazysyv@mailinator.com', 'Active', 1, 0, '2026-09-04 23:45:58', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2026-09-05 05:45:58', '2026-09-05 05:45:58');
*/
...
/* Legacy student seed data retained for reference; normalized seed data follows.
...
(27, NULL, 'PEND5383E942', '2026-57129', 'Meghan', 'Kinney', 'Gavin Noble', 'Other', '2006-11-28', 'Deleniti deserunt ni', NULL, '0949 8792 157', 'momazysyv@mailinator.com', '12', 'Active', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '(To be updated)', '(To be updated)', '(To be updated)', NULL, NULL, '2026-09-05 05:45:58', NULL);
*/
...
/* Legacy teacher seed data retained for reference; normalized seed data follows.
...
(5, 'TCH-2026-92546', NULL, 'Judith', 'Stevens', 'kajymojizu@mailinator.com', '0911 9143 565', 'Tempore repudiandae', 'Active', '2026-09-05 05:45:32');
*/
...
INSERT INTO `users` (`user_id`, `first_name`, `last_name`, `middle_name`, `password_hash`, `email`, `role`, `status`, `is_deleted`) VALUES
...
ALTER TABLE `students`
  ...
  ADD CONSTRAINT `fk_students_strand` FOREIGN KEY (`strand_id`) REFERENCES `strands` (`strand_id`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_students_guardian` FOREIGN KEY (`guardian_id`) REFERENCES `guardians` (`guardian_id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
-- Legacy enrollment-management and accounting tables are intentionally excluded from the LMS.
SET FOREIGN_KEY_CHECKS = 0;
DROP VIEW IF EXISTS `v_lms_accounts`;
